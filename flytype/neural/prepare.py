...
def prepare(dataset="malecns_v1"):
    ...
    manifest = {
        ...
        "motor_interface": "FlyType uses DNp20 mean right-minus-left firing to select LEFT/RIGHT/HOLD; DNpe017 spikes are logged for comparison only. This is an engineered character-selection interface, not a trading interface.",
